...
from policypirates_handler import PolicyLensHandler
...
@app.route('/')
def index():
    return send_from_directory('.', 'policypirates_frontend.html')


@app.route('/api/health')
def health_check():
    return jsonify(status='healthy', message='PolicyPirates API is running')
